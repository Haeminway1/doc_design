...
1. **PDF 안전 CSS만 사용** — gradient, box-shadow, text-shadow, rgba, opacity, backdrop-filter 금지. 솔리드 컬러 + `!important`. 상세: `.Codex/docs/design-rules.md`
...
| 문서 | 내용 |
|---|---|
| `.Codex/docs/workflow-textbook.md` | 빌드 명령어, 매니페스트 구조, 추출 스크립트 목록 |
| `.Codex/docs/design-rules.md` | CSS 규칙, 색상 팔레트, 강조 규칙, paged.js 가이드 |
